        ...
        >
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center">
              ...
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white">LRT-2 Route Planner</h2>
          ...
          <div className="space-y-4">
            <motion.div variants={itemVariants}>
              ...
              <select
                ...
                className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
              >
            ...
            <motion.div variants={itemVariants}>
              ...
              <select
                ...
                className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 disabled:bg-gray-50 dark:disabled:bg-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
              >
          ...
          <AnimatePresence mode="wait">
            {!result ? (
              ...
              <motion.div
                ...
                exit="hidden"
              >
                <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4 mb-6">                  <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">₱{result.fare}</div>                      <div className="text-sm text-gray-600 dark:text-gray-300">
                      ...
                      <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">{result.estimatedTime}</div>
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-start justify-between">                                <div className="flex-1">
                                ...
                                {!showCommuteDetails && uniqueConnections.length > 0 && (                                  <button
